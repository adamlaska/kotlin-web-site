...
2. **Create your first application for iOS and Android:**
   ...
   * If you prefer real-life examples, clone and play with an existing project, for example the networking and data storage project from the [hands-on tutorial](multiplatform-mobile-ktor-sqldelight.md) or any [sample project](multiplatform-mobile-samples.md).
